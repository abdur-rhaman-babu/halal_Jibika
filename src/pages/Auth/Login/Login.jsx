    ...
    return (
          ...
          <input type="email" onChange={onChangehandle} value={login.email} name="email" placeholder="Email or phone number"/>
          </div>
          ...
          value={login.password} name="password" placeholder="Password" required/>
          ...
          <div className={styles.SocialLogin}> <SocialLogin/></div>
